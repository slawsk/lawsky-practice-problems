...
current_year_for_book = 2024
rev_proc_for_book = 'Rev. Proc. 2023-34'

code_updated = 'December 1, 2023'

regs_updated = 'December 1, 2023'

code_updated_bk = "June 30, 2023"
...
page_style_dict = {'max-width':'1200px','margin-left':'auto','margin-right':'auto','background-color':'#fff'}   
