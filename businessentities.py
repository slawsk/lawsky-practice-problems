...
per_se_ed = [
    ...
    "Ecuador, Sociedad Anonima",
    "Ecuador, Compania Anonima",
...
terms_by_country_ed_dict = {
    ...
    "Australia": {
        ...
        "Unlimited Proprietary Company": "Pty",
    ...
    "Dominican Republic": {
        "Sociedad Anonima": "SA",
        "Sociedad de Resposabilidad Limitada": "SRL",
        "Empresa Individual de Responsabilidad Limitada": "EIRL",
    },
    "Ecuador": {
        "Sociedad Anonima": "SA",
...
languages = {
    ...
    "French": ["France", "Haiti", "Luxembourg"],
    "Portugese": ["Brazil", "Portugal"],
}
...
in_use_dict = {
    "Corporation": ["corp.", "inc.", "ag"],
    "General Partnership": ["ltda", "og", "snc"],
    "Joint Venture": [],
    "Limited": ["ltd", "ltda", "gmbh", "tapui", "srl", "scs", "limited", "lda."],
    "Limited Liability Company": ["llc", "plc", "srl", "sarl", "nv", "sa"],
...
dictionary_by_general_type = {
    "Limited Liability Company": [
        ["Argentina", "Sociedad Anonima", "sa"],
        ["Argentina", "Sociedad de Responsabilidad Limitada", "srl"],
        ["Australia", "Public Limited Company", "plc"],
        ["Belgium", "Societe Anonyme", "sa"],
        ["Brazil", "Sociedade Anonima", "sa"],
        ["Chile", "Sociedad Anonima", "sa"],
        ["Colombia", "Sociedad Anonima", "sa"],
        ["Dominican Republic", "Sociedad Anonima", "sa"],
        ["Dominican Republic", "Sociedad de Resposabilidad Limitada", "srl"],
        ["Ecuador", "Sociedad Anonima", "sa"],
        ["Guatemala", "Sociedad Anonima", "sa"],
        ["Haiti", "Sociedad Anonima", "sa"],
        ["Luxembourg", "Societe Anonyme", "sa"],
        ["Luxembourg", "Societe a responsabilite limitee", "sarl"],
        ["Mexico", "Sociedad Anonima", "sa"],
        ["Netherlands", "Commanditaire vennootschap", "nv"],
        ...
        ["Switzerland", "Societe Anonyme", "sa"],
        ["Switzerland", "Societe a responsabilite limitee", "sarl"],
        ["United Kingdom", "Public Limited Company", "plc"],
        ["United States", "Limited Liability Company", "llc"],
    ],
    "Limited Partnership": [
        ["Argentina", "Sociedad en Comandita por Acciones", "scpa"],
        ["Austria", "Kommanditgesellschaft", "kg"],
        ["Belgium", "gewone commanditaire vennootschap", "comm.v"],
        ["Canada", "Limited Partnership", "lp"],
        ["France", "Societe en commandite simple", "scs"],
        ["Germany", "Kommanditgesellschaft", "kg"],
        ["Mexico", "Sociedad en Comandita Simple", "s. en c."],
        ["Spain", "Sociedad Comanditaria", "s.cra"],
        ["United Kingdom", "Limited Partnership", "lp"],
        ["United States", "limited partnership", "lp"],
    ],
    "Limited Liability Partnership": [
        ["Australia", "Limited Liability Partnership", "llp"],
    ...
    "General Partnership": [
        ...
        ["Belgium", "vennootschap onder firma", "vof"],
        ["France", "Societe en nom collectif", "snc"],
    ...
    "Limited": [
        ...
        ["India", "Public Limited Company", "ltd"],
        ["New Zealand", "limited liability company", "limited"],
        ["Nigeria", "Private Limited Company", "ltd"],
        ["Portugal", "Limitada", "lda."],
        ["Switzerland", "Gesellschaft mit beschrankter Haftung", "gmbh"],
    ],
...
# First item: 0 = U.S., 1 = foreign
# Second item: 0 = 1 member, 1 = > 1 member
# Third item: 0 = someone has unlimited liability,
...
triple_default_elect_dict = {
    "[0, 0, 1]": {"default": "disregarded entity", "elect": "corporation"},
...
def pick_per_se_entity():
    ...
    member_language = random.choice(
        ["has only one member.", "has more than one member."]
    )
    liability_language = f"All members of {entity_name} have limited liability."
    default_choice = ""
    elect_choice = ""
    type_triple = ""
    per_se_entity = BusinessEntity(
        country,
        entity_type,
        entity_suffix,
        entity_name,
...
def pick_other_entity():
    ...
    while type_triple == [0, 0, 0] or type_triple == [1, 0, 0]:
        type_triple = [
            random.choice([1, 0]),
            random.choice([1, 0]),
            random.choice([1, 0]),
    ...
    if type_triple[0] == 0:
        ...
        while entity_partial[0] + ", " + entity_partial[1] in per_se_ed:
            entity_partial = random.choice(
                dictionary_by_general_type_no_US[classification]
            )
