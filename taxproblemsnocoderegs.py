...
app = dash.Dash(__name__, meta_tags=[
    {"name": "viewport", "content": "width=device-width, initial-scale=1"}, {'name': "description",
                                                                             'content': "Free practice problems and quizzes for Federal Income Taxation law school classes."}, {'name': "google-site-verification", 'content': "Cmw463c-ZgWSE_OZOraY3c4DGeppNfyb3MuTGLjFSGg"}
...
app.layout = html.Div([
    ...
    html.Div(id='page-content', style={'max-width': '1200px', 'margin': '0 auto',
                                       'padding': '0 5%', 'background-color': '#fff', 'min-height': '100vh'})
...
fed_tax_layout = html.Div(children=[
    ...
    dbc.Button(children=['Switch to Partnership'],
               id='switch_problem_type_button', n_clicks=0),
    ...
    dcc.Markdown(faq.partnership_addl_info, id='partnership-info',
                 style={'display': 'none'}),
    ...
    dbc.Button('Submit Answer', id='submitanswer_button',
    ...
    dbc.Button('Shhhh', id='hidden-counter-1',
               n_clicks=0, style={'display': 'none'}),
    html.Div(id='current-type-problem',
             children=['Federal Income Tax'], style={'display': 'none'}),
...
rates_layout = html.Div([
    ...
    dbc.Input(id='taxable-income', type='number',
    ...
    dbc.Button('Reset Income', id='resetincome_button',
    ...
    # this hidden button resets the explanation when someone picks a new type of problem
    dbc.Button('Shhhh', id='hidden-counter-rates',
               n_clicks=0, style={'display': 'none'}),
...
statutes_layout = html.Div(children=[
    ...
    dbc.Input(id='statute_answer', type='number', style={
              'display': 'none', 'width': '10em', 'maxwidth': '100%'}),

    html.Br(),

    dbc.Button('Submit Answer', id='submit_statute_answer_button',
               n_clicks=0, style={'display': 'none'}),
...
quiz_layout = html.Div(children=[
    ...
    html.Br(),
    dbc.Input(id='number-questions', type='number',
    ...
    dbc.Button('Submit Answers', id='quiz_submit_button',
               n_clicks=0, style={'display': 'none'}),
    html.Br(),
    ...
    html.Div([html.Div(
        ...
        children=[html.Div('To download these questions, answers, and explanations, click here.', id='offer-download'),
                  ...
                  dbc.Button('Download Answers',
                             id='download_quiz_button', n_clicks=0),
                  ...
                  html.Br(),
                  html.Div(
                      'To reset this quiz in order to take a new quiz, click here.', id='offer-reset-quiz'),
...
def pick_type_problem(n_click, type_value):
    ...
    if n_click == 0:
        ...
        pick_dictionary = {'Federal Income Tax': [
            bt, {'display': 'none'}], 'Partnership Tax': [pt, {'display': 'block'}]}
...
@app.callback([Output('full_problem', 'children'),
               ...
               Output(component_id='possible-answers-dropdown-id',
...
@app.callback([Output('statute_problem', 'children'),
               ...
               Output(component_id='statute_answer',
                      component_property='style'),
...
def create_quiz(n_clicks, types_problem, number_questions):
    if n_clicks == 0:
        return_list = ['', '', {'display': 'none'}, '', '', {'display': 'none'}, '', '', {'display': 'none'}, '', '', {'display': 'none'}, '', '', {'display': 'none'}, '', '', {
        ...
        for n in range(number_questions):
            ...
            [problemtext, cleananswers, json_dict,
                correct_answer] = bt.function_picker(problem_type)
...
{problemtext}'''
            ...
            correct_dict[f"Problem {n+1}"] = {
                correct_answer: correct_explanation}
...
def score_quiz(n_clicks, answer1, problem1, answer2, problem2, answer3, problem3, answer4, problem4, answer5, problem5, answer6, problem6, answer7, problem7, answer8, problem8, answer9, problem9, answer10, problem10, jsondict, numberquestions):
    if n_clicks == 0:
        ...
        completeanswerlist = [answer1, answer2, answer3, answer4,
                              answer5, answer6, answer7, answer8, answer9, answer10]
        completeproblemlist = [problem1, problem2, problem3, problem4,
