...
general_faq = '''  
This website is created and maintained by [Sarah Lawsky](http://www.law.northwestern.edu/faculty/profiles/SarahLawsky/), a tax law professor at [Northwestern Pritzker School of Law](http://www.law.northwestern.edu/). The website is coded with [Dash](https://plot.ly/dash/) and [Python](https://www.python.org/). See the [other projects page](https://www.lawskypracticeproblems.org/otherprojects/) for more information on the code.
...
This page allows you to create a PDF of selected tax Code and regulation sections for {fm.current_year_for_book} for almost any U.S. federal tax class in only four steps, one of which is optional, and one of which just involves waiting.'''
...
code_template_explanation = '''Create an Excel spreadsheet listing the Code and regulation sections and subsections you want in your Selected Sections book, and format it so that the program can process it. The simplest way to do this is click on this link [to download the spreadsheet with sections and subsections I use in my class](/assets/CodeAndRegSectionsToUse.xlsx) and then modify that spreadsheet--essentially, use it as a template. Here are some tips:
...
other_projects_info = '''The website is coded with [Dash](https://plot.ly/dash/) and [Python](https://www.python.org/). You can see all the code for this website on [Github](https://github.com/slawsk/lawsky-practice-problems/), and you can use the code you find there for anything, subject to the terms of [the license under which I have made this code available](https://www.gnu.org/licenses/agpl-3.0.en.html).

If you build a project using this code, please let me know, so I can add a link and a description on this page.'''

other_projects_list = '''John J. Nay, David Karamardian, Sarah B. Lawsky, Wenting Tao, Meghana Bhat, Raghav Jain, Aaron Travis Lee, Jonathan H. Choi, and Jungo Kasai, [Large Language Models as Tax Attorneys: A Case Study in Legal Capabilities Emergence](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4476325), 381 Phil. Transactions of the Royal Society A (forthcoming 2024), used the code underlying this website to generate problems to assess the capabilities of large language models to answer tax law questions.'''